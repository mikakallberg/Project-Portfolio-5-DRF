"""
Django settings for p5_api project.
...
REST_USE_JWT = True
# For secure HTTPS url-pattern:
JWT_AUTH_SECURE = True
JWT_AUTH_COOKIE = 'my-app-auth'
JWT_AUTH_REFRESH_COOKIE = 'my-refresh-token'
# unblocking cookies between front end and back end
JWT_AUTH_SAMESITE = 'None'


REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER': 'p5_api.serializers.CurrentUserSerializer'
}
